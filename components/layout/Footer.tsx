...
import { FiMail, FiShield, FiNavigation } from "react-icons/fi";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 mb-12 md:mb-20">
            ...
            <div className="flex gap-4">
              {[
                ...
                <Link
                  ...
                  aria-label={label}
                  className="w-12 h-12 rounded-2xl bg-card border border-border flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-500 shadow-xl"
                >
                  <Icon size={20} />
                </Link>
              ))}
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <FooterLinkGroup 
              title="Features" 
              links={[
                { name: "Nearby Deals",     href: "/nearby" },
                { name: "Budget Shopping",  href: "/budget-shopping" },
                { name: "Price Estimator",  href: "/price-estimator" },
                { name: "Saved / Wishlist", href: "/saved" },
            ...
            <FooterLinkGroup 
              ...
              links={[
                ...
                { name: "Post an Ad",       href: "/create-ad" },
              ...
              <div className="relative p-8 rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-blue-700 text-white shadow-2xl shadow-blue-500/20 overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    />
                    <button className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-lg transition-all active:scale-95 w-full">
                      Join
                    </button>
                  </div>
                </div>
      ...
      <ul className="space-y-4">
        {links.map((link) => (
          <li key={link.name} className="group flex items-center gap-2">
            ...
            <Link
              href={link.href}
              className="text-sm font-bold text-muted-foreground group-hover:text-foreground transition-all hover:translate-x-1 hover:text-primary block w-full py-1"
            >
              {link.name}
            </Link>
          </li>
